...
const formSchema = z.object({
  ...
  liveSite: z
    .string()
    .url("Please enter a valid URL")
    .min(1, "Live site URL is required"),
    ...
    const fetchProject = async () => {
      try {
        ...
        if (res.success) {
          ...
          form.setValue("liveSite", project.liveSite);
          form.setValue("features", project.features || []);
          form.setValue("techStack", project.techStack || []);
          form.setValue("isFeatured", project.isFeatured);
          form.setValue("isPublished", project.isPublished);
