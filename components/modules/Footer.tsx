...
const FooterMenu = ({ footerMenu }: { footerMenu: { title: string; href: string }[] }) => {
    ...
    return (
        ...
        >
            ...
            <ul className="flex flex-col space-x-0 space-y-5 sm:flex-row sm:space-x-4 sm:space-y-0">
                ...
                {linkedin && (
                    <li className="">
                        <a href={linkedin} rel="nofollow" className="flex items-center gap-2">
                ...
                {twitter && (
                    <li className="">
                        <a href={twitter} rel="nofollow" className="flex items-center gap-2">
